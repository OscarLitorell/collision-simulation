...
def main(name):
    ...
    collision_properties = {
        "name": name,
        "pos_0": collision_info[0]["pos"].tolist(),
        "pos_1": collision_info[1]["pos"].tolist(),
        "vel_0_before": collision_info[0]["vel"][0].tolist(),
        "vel_1_before": collision_info[1]["vel"][0].tolist(),
        "vel_0_after": collision_info[0]["vel"][1].tolist(),
        "vel_1_after": collision_info[1]["vel"][1].tolist(),
